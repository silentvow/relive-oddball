// Renders while app/wang-low/page.tsx awaits its server fetches.
// Mirrors the homepage skeleton but with 7 slot placeholders.

export default function WangLowLoading() {
  return (
