...
export async function generateMetadata({ params }: { params: Params }) {
  return {
    title: "海亞！法克你又望樓 — 別人的怪咖排名",
    description: "看看這個人怎麼排海亞！法克你又望樓的怪咖度。",
  };
}

export default async function WangLowSharePage({ params }: { params: Params }) {
